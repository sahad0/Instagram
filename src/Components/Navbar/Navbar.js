  ...
  const content1 = (
    <div style={{ width: "300px" }}>
      ...
      <p onMouseOver={(e) => { e.target.style.background = "#FAFAFA" }} onMouseLeave={(e) => { e.target.style.background = "#FFF" }}  >
        ...
        <svg aria-label="Saved" className="_ab6- mx-2" color="#262626" fill="#262626" height="16" role="img" viewBox="0 0 24 24" width="16"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon></svg>
      ...
      <nav className="navbar sticky-top navbar-expand-lg " style={{ boxShadow: "0 4px 4px -6px #222", backgroundColor: "white", zIndex: "1" }}>
        <div className="container-fluid" style={{ display: "flex", flexDirection: "row" }}>
            ...
            <div className="row">
              ...
              <div className="col-md-5">
                <a className="navbar-brand" href="/login">
                  <img src={Instagram} draggable="false" alt="insta" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-5">
            ...
            <Icons home={home} checkTrue={checkTrue} Home={Home} message={message} Message={Message} people={people} People={People} activity={activity} Activity={Activity} />
            <Popover content={content1} trigger="click" placement='bottomRight' >
              <Avatar className='mx-2' style={{ cursor: "pointer" }} onClick={Profile} size={25} src={Me} />
            </Popover>
