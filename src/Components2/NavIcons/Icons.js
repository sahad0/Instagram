...
export default function Icons({home,Home,message,Message,post,Post,people,People,activity,Activity}) {
  return (
   <>
     {/* Button1 */}
     {home ? 
