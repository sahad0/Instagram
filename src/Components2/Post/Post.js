...
export default function Post({post}) {
    if(post){
        return post.map((posts,i)=>{
           return (
            <>
                 <div className='card my-3 mx-1' key={i}>
                          <div style={{display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
                            <div>
                              <Avatar size={38} className='my-3 mx-2'  src={posts.source} />
                              <span style={{cursor:"pointer"}}>{posts.name}</span>
                            </div>
                            <svg className='m-2' style={{cursor:"pointer",marginTop:"20px",marginRight:"10px"}} aria-label="More Options" class="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><circle cx="12" cy="12" r="1.5"></circle><circle cx="6" cy="12" r="1.5"></circle><circle cx="18" cy="12" r="1.5"></circle></svg>
                          </div>
                          ...
                          <div className='card-body'>
                            ...
                            <div style={{display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
                              ...
                              <svg style={{marginLeft:"5px"}} aria-label="Comment" class="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 10-3.59 3.615L22 22z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
                            ...
                            <div className='my-1 mx-1' style={{fontWeight:"bold"}}> 1000 likes </div>
