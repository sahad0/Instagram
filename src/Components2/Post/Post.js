...
export default function Post({post,setPost}) {
  ...
  const content =(_id)=>{
    return(<>
      ...
      <svg  style={{width:"18px",height:"18px"}} className="trashcan"  x="0px" y="0px" viewBox="0 0 25 24.8"  xmlSpace="preserve" classname="icon-trashcan ct-delete" data-ember-action data-ember-action-1015={1015}>
                          ...
                          <div className='card-body'>
                            ...
                            <div style={{display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
                              ...
                              <Space>
                                ...
                                :
                                <><svg onClick={() => save(posts.id_)} aria-label="Remove" class="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20 22a.999.999 0 01-.687-.273L12 14.815l-7.313 6.912A1 1 0 013 21V3a1 1 0 011-1h16a1 1 0 011 1v18a1 1 0 01-1 1z"></path></svg></>
